...
class FileDialog():
    ...
    def __init__(self, pyscreen, pos, startdir=None, title="Open File Dialog",dfontname=None,dfontsize=24, ext="*",parentRedraw=None):
        ...
        self.tbFilename= TextBox(pyscreen,backcolor=(255,255,255),textcolor=(0,0,0),bordercolor=(0,0,0),rect=GRect())
        self.reposControls()
